...
namespace AirManager.Controls
{
    public partial class PlaylistEditorControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                if (!_splitInitialized && mainSplit.Width > 100)
                {
                    try
                    {
        ...
        private TabPage BuildMusicTab()
        {
            ...
            _dgvMusic.Columns.Add(new DataGridViewTextBoxColumn { Name = "Artist", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Artist", "Artista"), Width = 180 });
            _dgvMusic.Columns.Add(new DataGridViewTextBoxColumn { Name = "Title", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Title", "Titolo"), AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill });
            _dgvMusic.Columns.Add(new DataGridViewTextBoxColumn { Name = "Genre", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Genre", "Genere"), Width = 80 });
            _dgvMusic.Columns.Add(new DataGridViewTextBoxColumn { Name = "Duration", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Duration", "Durata"), Width = 60 });
        ...
        private TabPage BuildClipsTab()
        {
            ...
            _dgvClips.Columns.Add(new DataGridViewTextBoxColumn { Name = "Title", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Title", "Titolo"), AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill });
            _dgvClips.Columns.Add(new DataGridViewTextBoxColumn { Name = "Genre", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Genre", "Genere"), Width = 80 });
            _dgvClips.Columns.Add(new DataGridViewTextBoxColumn { Name = "Duration", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Duration", "Durata"), Width = 60 });
        ...
        private TabPage BuildPlaylistsTab()
        {
            ...
            _dgvPlaylists.Columns.Add(new DataGridViewTextBoxColumn { Name = "Name", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Name", "Nome"), AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill });
            _dgvPlaylists.Columns.Add(new DataGridViewTextBoxColumn { Name = "Modified", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Modified", "Modificato"), Width = 130 });
            _dgvPlaylists.Columns.Add(new DataGridViewTextBoxColumn { Name = "Items", HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Items", "Elementi"), Width = 70 });
        ...
        private void ApplyLanguage()
        {
            ...
            // Editor grid columns
            if (_dgvEditor?.Columns.Count > 0)
            {
                if (_dgvEditor.Columns.Contains("colTime")) _dgvEditor.Columns["colTime"].HeaderText = LanguageManager.GetString("PlaylistEditor.ColumnTime", "Orario");
                if (_dgvEditor.Columns.Contains("colType")) _dgvEditor.Columns["colType"].HeaderText = LanguageManager.GetString("PlaylistEditor.ColumnType", "Tipo");
                if (_dgvEditor.Columns.Contains("colElement")) _dgvEditor.Columns["colElement"].HeaderText = LanguageManager.GetString("PlaylistEditor.ColumnElement", "Elemento");
                if (_dgvEditor.Columns.Contains("colDuration")) _dgvEditor.Columns["colDuration"].HeaderText = LanguageManager.GetString("PlaylistEditor.ColumnDuration", "Durata");
            }

            // Music archive grid columns
            if (_dgvMusic?.Columns.Count > 0)
            {
                if (_dgvMusic.Columns.Contains("Artist")) _dgvMusic.Columns["Artist"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Artist", "Artista");
                if (_dgvMusic.Columns.Contains("Title")) _dgvMusic.Columns["Title"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Title", "Titolo");
                if (_dgvMusic.Columns.Contains("Genre")) _dgvMusic.Columns["Genre"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Genre", "Genere");
                if (_dgvMusic.Columns.Contains("Duration")) _dgvMusic.Columns["Duration"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Duration", "Durata");
            }

            // Clips archive grid columns
            if (_dgvClips?.Columns.Count > 0)
            {
                if (_dgvClips.Columns.Contains("Title")) _dgvClips.Columns["Title"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Title", "Titolo");
                if (_dgvClips.Columns.Contains("Genre")) _dgvClips.Columns["Genre"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Genre", "Genere");
                if (_dgvClips.Columns.Contains("Duration")) _dgvClips.Columns["Duration"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Duration", "Durata");
            }

            // Playlists grid columns
            if (_dgvPlaylists?.Columns.Count > 0)
            {
                if (_dgvPlaylists.Columns.Contains("Name")) _dgvPlaylists.Columns["Name"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Name", "Nome");
                if (_dgvPlaylists.Columns.Contains("Modified")) _dgvPlaylists.Columns["Modified"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Modified", "Modificato");
                if (_dgvPlaylists.Columns.Contains("Items")) _dgvPlaylists.Columns["Items"].HeaderText = LanguageManager.GetString("PlaylistEditor.Column.Items", "Elementi");
            }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(name))
            {
                MessageBox.Show(
                    ...
                    "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            try
            {
                ...
                MessageBox.Show(
                    ...
                    "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(
        ...
        private void BtnDeletePlaylist_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                RefreshPlaylistList();
                MessageBox.Show(LanguageManager.GetString("PlaylistEditor.PlaylistDeleted", "✅ Playlist eliminata"), "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void BtnAddRule_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(LanguageManager.GetString("PlaylistEditor.SelectCategory", "⚠️ Seleziona una categoria"), "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if ((isGenre || isBoth) && string.IsNullOrEmpty(genName))
            {
                MessageBox.Show(LanguageManager.GetString("PlaylistEditor.SelectGenre", "⚠️ Seleziona un genere"), "AirManager", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
