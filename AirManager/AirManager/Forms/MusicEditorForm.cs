...
namespace AirManager.Forms
{
    public partial class MusicEditorForm : Form
    {
        ...
        // ✅ PENDING VOLUME APPLY (ffmpeg deferred to form close)
        ...
        private void BtnApplyVolume_Click(object sender, EventArgs e)
        {
            ...
            // ✅ Salva i parametri pendenti — ffmpeg verrà lanciato al salvataggio del form
                    ...
                    if (_pendingVolumeApply)
                    {
                        ...
                        Task.Run(() =>
                        {
                            try
                            {
                                ...
                                if (completed && process.ExitCode == 0 && File.Exists(tempFile))
                                {
                                ...
                                else
                                {
                                    ...
                                    Console.WriteLine(completed
                                        ? $"[MusicEditor] ❌ ffmpeg failed (deferred)"
                                        : $"[MusicEditor] ❌ ffmpeg timed out (deferred)");
                                }
                            }
                            catch (Exception ex)
                            {
